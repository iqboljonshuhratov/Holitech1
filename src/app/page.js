...
export default function Home() {
  ...
  return (
    <Box className="flex justify-between items-center justify-between">
      <div className="contend pt-[70px] max-w-[650px] ">
        <Box
          sx={{
            marginBottom: "30px",
        ...
        >
          Yotubedan pul ishlab <br /> qarzlaringizdan xalos bo’ling
        </Typography>
        <Typography
          sx={{
            color: "white",
        ...
        >
          Tayyor daromadli youtube kanal yutib olish imkoniga egasi
        </Typography>
          ...
          >
            <Button
              sx={{
                ...
                borderRadius: "18px",
                backgroundImage:
                  "linear-gradient(0.283turn, rgba(70, 192, 154, 1) 0%, rgba(3, 223, 155, 1) 50%, rgba(70, 192, 154, 1) 100%)",
                borderColor: "transparent",
                borderStyle: "solid",
                transition:
                  "background-color 0.2s ease-in-out, color 0.2s ease-in-out, border-color 0.2s ease-in-out",
                boxShadow: "0px 5px 0px 0px rgba(36, 104, 83, 1)",
                "&:hover": {
                  backgroundImage:
                    "linear-gradient(0.283turn, rgba(70, 192, 154, 1) 0%, rgba(3, 223, 155, 1) 50%, rgba(70, 192, 154, 1) 100%)",
                },
      ...
      <Box
        sx={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(70, 192, 154, 1) 0%, rgba(70, 192, 154, 0) 80%)",
        }}
      >
        <img
          style={{ width: "407px", height: "auto" }}
          src="https://holitechb.netlify.app/1.png"
          alt="man"
        />
      </Box>
    </Box>
